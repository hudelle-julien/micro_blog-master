<?php
/* Smarty version 3.1.30, created on 2018-01-19 22:35:59
  from "P:\Data\hudellej\wamp64\www\micro_blog-master\includes\header.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a6272cf26ca15_51209762',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '492ef2fc69d525f6726b93c48bd3b9fd0d4e047c' => 
    array (
      0 => 'P:\\Data\\hudellej\\wamp64\\www\\micro_blog-master\\includes\\header.tpl',
      1 => 1516401352,
      2 => 'file',
    ),
  ),
...
function content_5a6272cf26ca15_51209762 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="fr">
...
> 
    ...
    <!-- For Internet Explorer below version 9 -->
    <!--[if lt IE 9]>
        <?php echo '<script'; ?>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="page-scroll">
                            <!-- Displays the connexion and subscription buttons if the user is logged and the disconnexion button if he isn't -->
                            ...
                            <?php } else { ?>
                            <a id="buttonDeconnexion" href="disconnexion.php">Deconnexion - <?php echo $_smarty_tpl->tpl_vars['pseudo']->value;?>
</a>
                        </li>
                        <?php }?>
                    <li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left; font-size: 1.1em">
                        <!-- Redirection to the connexion controller -->
        ...
        <div class="modal fade" id="modalInscription" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left; font-size: 1.1em">
                        <!-- Redirection to the subscription controller -->
                        <form action="subscription.php" id="formInscription" method="post">
                            <div class="form-group">
