...
// Search for the content given the string the user entered in the search bar and then, makes it so that only 4 messages appear by page
...
// Calculate number of pages given the total number of messages
